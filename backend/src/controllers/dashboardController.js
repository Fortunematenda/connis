...
const getDashboardStats = async (req, res, next) => {
  try {
    ...
    const [
      ...
      pool.query("SELECT COUNT(*) FROM messages WHERE company_id = $1 AND sender_type = 'customer' AND is_read = FALSE", [companyId]),
    ...
    res.json({
      ...
      data: {
        counts: {
          ...
          unread_messages: parseInt(unreadMessagesRes.rows[0].count) || 0,
