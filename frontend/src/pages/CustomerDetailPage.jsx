          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                {customer.username} &middot; Balance: <span className={parseFloat(customer.balance) >= 0 ? 'text-gray-600' : 'text-red-600'}>R{parseFloat(customer.balance || 0).toFixed(2)}</span> &middot; Since {fmtDate(customer.created_at)}
              </p>
            </div>
          </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {customer.plan_name ? (
                    ...
                    <tr><td colSpan={7} className="px-5 py-12 text-center text-gray-400 text-sm">No active services</td></tr>
                  )}
                </tbody>
              </table>
            </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
            ...
            <div className="px-6 py-4 border-b flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-semibold text-gray-900">Change Service Plan</h2>
              </div>
